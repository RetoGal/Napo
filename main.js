...
function gameStatusMessage ( GAME_STATE ) {
  document.getElementById( "gameBoard" + GAME_STATE.numberBoard ).style.display = "none"
  document.getElementById( "message" + GAME_STATE.numberBoard ).style.display = "block"

  GAME_STATE.theResultOfTheGame === "gameOver" ?  document.getElementById( "message" + GAME_STATE.numberBoard ).innerHTML = "Game Over" :
  GAME_STATE.theResultOfTheGame === "youWon" ? document.getElementById( "message" + GAME_STATE.numberBoard ).innerHTML = "Congratulations! youWon!" :
