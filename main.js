...
function gameStatusMessage ( GAME_STATE ) {
  ...
  if (GAME_STATE.theResultOfTheGame === "gameOver") {
     document.getElementById( "message" + GAME_STATE.numberBoard ).innerHTML = "Game Over"

  } else if (GAME_STATE.theResultOfTheGame === "youWon") {
     document.getElementById( "message" + GAME_STATE.numberBoard ).innerHTML = "Congratulations! youWon!"
  }
}
